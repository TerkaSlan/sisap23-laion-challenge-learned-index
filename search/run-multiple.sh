...
do
    for DATASET in pca32v2 #clip768v2 #pca32v2 #pca96v2 #pca32v2 #clip768v2 #pca32v2 #clip768v2 #pca32v2 # clip768v2
    do
        for LR in 0.001 0.01 0.1 #0.1 0.01 0.001 #0.025 #0.03 0.027 0.025 0.023 0.02 #0.07 0.05 0.03 0.025 0.02 #0.5 0.1 0.05 #0.01 0.001
        do
