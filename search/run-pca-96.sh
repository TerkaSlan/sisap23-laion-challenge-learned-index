...
#python3 search/search-dev.py --dataset=pca96v2 --emb=pca96 --size=10M --n-categories=1000 --epochs=1000 \
# 2>&1 | tee -a job-logs/$PBS_JOBID.log

python3 search/search-dev.py --dataset=pca96v2 --emb=pca96 --size=10M --n-categories=1000 --epochs=1000 --model-type=bigger \
 2>&1 | tee -a job-logs/$PBS_JOBID.log
#python3 search/search-dev.py --dataset=clip768v2 --emb=emb --size=10M --n-categories=1000 2>&1 | tee -a job-logs/$PBS_JOBID.log
