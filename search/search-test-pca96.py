...
def run(
    ...
    if index_type == 'baseline':
        ...
        target_models = [
            #'pca96v2-10M-ep=200-lr=0.01-cat=100-model=MLP-4-prep=True-858546.elixir-pbs.elixir-czech.cz.pkl',
            'pca96v2-10M-ep=300-lr=0.01-cat=100-model=MLP-4-prep=True-858398.elixir-pbs.elixir-czech.cz.pkl',
            'pca96v2-10M-ep=200-lr=0.001-cat=100-model=MLP-2-prep=True-858597.elixir-pbs.elixir-czech.cz.pkl'
            #learned-index-pca96v2-10M-ep=300-lr=0.01-cat=100-model=MLP-4-buck=4-858398.elixir-pbs.elixir-czech.cz
        ]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        '--n-buckets',
        nargs='+',
        default=[3] #, 4, 5, 6, 7, 8, 9, 10, 15, 20, 30]
    )
    parser.add_argument(
        '-bp',
        '--buckets-perc',
